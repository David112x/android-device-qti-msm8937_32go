...
TARGET_SYSTEM_PROP := device/qcom/msm8937_32go/system.prop
#Go variant flag
...
# Override heap growth limit and heapsize based on display density on device
PRODUCT_PROPERTY_OVERRIDES += \
...
ifeq ($(strip $(TARGET_KERNEL_VERSION)), 3.18)
    DEVICE_MANIFEST_FILE += device/qcom/msm8937_32go/manifest_target_level_2.xml
else ifeq ($(strip $(TARGET_KERNEL_VERSION)), 4.9)
    ifeq ($(strip $(BOARD_DYNAMIC_PARTITION_ENABLE)),true)
        DEVICE_MANIFEST_FILE += device/qcom/msm8937_32go/manifest_target_level_4.xml
    else
        DEVICE_MANIFEST_FILE += device/qcom/msm8937_32go/manifest_target_level_3.xml
    endif
endif
...
# Include CAS lazy hal on Go target.
# This would override the non-lazy CAS hal.
ifeq ($(strip $(TARGET_KERNEL_VERSION)), 4.9)
